...
public class SectionSpecs {
    ...
    public static Specification<Section> hasId(String providedSectionName) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("sectionName"), providedSectionName);
    }

    public static Specification<Section> containsAcademicYear(String providedAcademicYear) {
